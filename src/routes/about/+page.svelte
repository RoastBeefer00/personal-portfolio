<div class="m-2 flex flex-col h-screen">
	<div
	...
	>
		...
		<p class="mt-1">
			...
			Mayo Clinic on the Product Build team and provide cloud-based
			solutions on Google Cloud Platform that allow researchers to utilize
			AI.
		</p>
		<br />
		<p>
			I am happily married to my wife Rebecca and we have 8 pets: 3 dogs
	...
	<div class="flex-1" />
	<div
		class="p-2 mb-20 rounded bg-pink w-fit h-fit flex justify-center mx-auto"
	>
		<a href="https://github.com/RoastBeefer00?tab=repositories"
